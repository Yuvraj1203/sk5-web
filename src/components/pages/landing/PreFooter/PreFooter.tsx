  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 md:w-3/4 flex flex-col gap-5 md:gap-10">
        ...
        <ScheduleButton className="text-sm md:text-xl font-semibold px-6 py-4 md:px-12 md:py-8 w-fit rounded-full uppercase bg-on-background text-on-primary hover:bg-on-primary hover:text-on-background shadow-sm duration-250" />
      </div>
    </Section>
  );
};
